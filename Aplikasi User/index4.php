...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="basss4.css">
</head>
<body>
...
?>
    <table border="1" width="100%">
        ...
        <tr>
            ...
            <td> 
                <a href="aksi_hapus4.php?id=<?php echo $data['id_peminjaman'];?>" onclick="return confirm('Apakah yakin ?')">Batalkan Pinjam</a> 
            </td>
        </tr>
        <?php } ?>
    </table>
