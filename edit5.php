        ...
        <div class="container">
            ...
            <table>
                ...
                <?php
                    ...
                    $data = mysqli_query($conn, "SELECT * FROM pengembalian WHERE id_pengembalian='$id'");
                ...
                ?>
                <form action="aksi_edit5.php" method="POST">
                    <tr>
                        <td>ID Pengembalian</td>
                        <td> : </td>
                        <td><input type="text" name="id_pengembalian" placeholder="masukkan ID" value="<?php echo $id_pengembalian; ?>"></td>
                    </tr>
                    <tr>
                        <td>Tanggal Pengembalian</td>
                        <td> : </td>
                        <td><input type="date" name="tanggal_pengembalian" placeholder="masukkan tanggal" value="<?php echo $row['tanggal_pengembalian']; ?>"></td>
                    </tr>
                    <tr>
                        <td>Denda</td>
                        <td> : </td>
                        <td><input type="text" name="denda" placeholder="masukkan jumlah denda" value="<?php echo $row['denda']; ?>"></td>
                    </tr>
                    <tr>
                        <td>ID Buku</td>
                        <td> : </td>
